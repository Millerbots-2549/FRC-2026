...
public final class IntakeConstants {
  ...
  public static final double PIVOT_MAX_DEGREES = 104.58;
  ...
  public static final double PIVOT_MAX_VELOCITY = 2.5;
  public static final double PIVOT_MAX_ACCELERATION = 2.25;
