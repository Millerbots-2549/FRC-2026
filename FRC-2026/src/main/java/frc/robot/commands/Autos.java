...
/** Add your docs here. */
public class Autos {
  public static final PathConstraints FAST_PATH_CONSTRAINTS =
      new PathConstraints(0.0, 0.0, 0.0, 0.0);
   ...
   * @return
   */
  public static Command singleCycleAuto(
      Shooter shooter, Indexer indexer, Intake intake, Drive drive) {
    ...
    return new SequentialCommandGroup(
        new ParallelCommandGroup(
            ShooterCommands.shootWithHoming(shooter, indexer, () -> drive.getDistToHub()),
            DriveCommands.driveToPoseWhileAiming(
                drive,
                () -> toCycleStart.getStartingDifferentialPose().getTranslation(),
        ...
        new ParallelCommandGroup(
            ShooterCommands.shootWithHoming(shooter, indexer, () -> drive.getDistToHub()),
            DriveCommands.driveToPoseWhileAiming(
                drive, () -> Constants.ROBOT_AGAINST_HUB, () -> Constants.HUB_TRANSLATION)));
  }
}
